...
|:---:|:---|:---|:---|:---:|:---:|:---|
| ① | **비유설계** | 비유↔기술 구조 매핑 | Gemini Flash | 0.7 | 2048 | 3회 재시도 + fail_summary feedback |
| ② | **글작성** | 한국어 본문 생성 | Gemini Flash | 0.7 | 2048 | 5게이트 검증 + 2회 재시도 |
| ③ | **이미지프롬프트** | intro/middle/outro | Gemini Lite | 0.7 | 0 | 영문 프롬프트 (Nano Banana 입력용) |
| ④ | **검증** | 4단계 명세 검증 (A·B) | Gemini Lite | 0.0 | 2048 | 4단계 inspect→measure→evidence→verdict |
